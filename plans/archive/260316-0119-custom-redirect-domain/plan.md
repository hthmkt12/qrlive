...
| # | Phase | File | Status |
|---|-------|------|--------|
| 1 | [Env var + getRedirectUrl](./phase-01-env-and-redirect-url.md) | `src/lib/db.ts`, `.env.example` | Done |
| 2 | [Cloudflare Worker proxy](./phase-02-cloudflare-worker.md) | `cloudflare-worker/redirect-proxy.js` (new) | Done |
| 3 | [Deploy guide](./phase-03-deploy-guide.md) | `docs/deployment-guide.md` | Done |
